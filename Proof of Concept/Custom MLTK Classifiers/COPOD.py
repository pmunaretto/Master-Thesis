...
class COPOD(ClustererMixin, BaseAlgo):
    ...
    def __init__(self, options):
        ...
        self.estimator = _COPOD(**out_params)
    ...
    def fit(self, df, options):
        ...
        # Fit the COPOD classifier on the training dataset
    ...
    def apply(self, df, options):
        ...
        # Predict the inference dataset with the trained COPOD clsasifier and convert the integer results to strings
    ...
    def register_codecs():
        ...
        codecs_manager.add_codec("algos_contrib.COPOD", "COPOD", SimpleObjectCodec)
        codecs_manager.add_codec("pyod.models.copod", "COPOD", SimpleObjectCodec)
